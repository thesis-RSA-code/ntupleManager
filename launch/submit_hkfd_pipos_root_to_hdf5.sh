#!/bin/bash
# Submit HK id_pipos production ntuple -> hierarchical HDF5 (~100k events).
...
YAML_CONFIG="/sps/t2k/eleblevec/Datasets/prod_datasets/hkfd_prod_pipos/hkfd_pi+_rwcs_500k.yaml"
LOG_DIR="/sps/t2k/eleblevec/Datasets/prod_datasets/hkfd_prod_pipos/logs"
