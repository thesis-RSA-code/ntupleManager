...
TMP_DIR="${TMPDIR:-/tmp/hadd_scratch_$$}"
...
# HK_FD dataset
# ENERGY_RANGE="100-1000MeV"
ENERGY_RANGE="50-1500MeV"
BASEFILE_NAME="ntuple_cut_ed_100.root"

# export BASEDIR="/sps/t2k/bquilain/HK/Reconstruction/official_2023/Gonzalo/WCSim-1.12.20/Simulation/HK_uni_iso_4.2kHz/WCSim_v1.12.20_HyperK_HybridmPMT_WithOD_Realistic/"
BASE_INPUT_DIR=/sps/t2k/eleblevec/Datasets/custom_wcsimroot_datasets/prod_HKFD_ben_1.12.20corr/HyperK_HybridmPMT_WithOD_Realistic
FINAL_INPUT_DIR=${BASE_INPUT_DIR}/${PARTICLE}/${ENERGY_RANGE}
# FINAL_INPUT_DIR=${BASE_INPUT_DIR}

TEST_STARTFILE=1
TEST_END_FILE=1000
TRAIN_VAL_STARTFILE=1001
TRAIN_VAL_END_FILE=10000


# BASE_SAVE_DIR="/sps/t2k/eleblevec/mini-Caverns-toolsbox/playground/ntupleManager/hadd_hirar_test/"
BASE_SAVE_DIR="/sps/t2k/eleblevec/Datasets/custom_dataset/${PARTICLE}/${ENERGY_RANGE}/Ndigit_40_1Mevents"
...
ls -l ${FINAL_INPUT_DIR}/1/${BASEFILE_NAME}
echo ""
...
echo ""
echo "Save PARTICLE: ${BASE_SAVE_DIR}/train_val_${TRAIN_VAL_STARTFILE}_a${TRAIN_VAL_END_FILE}"
